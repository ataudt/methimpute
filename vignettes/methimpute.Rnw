...
\begin{small}
<<methylation_status_calling, results='show', message=FALSE, eval=TRUE, fig.width=10, fig.height=7, out.width='\\textwidth', fig.align='center'>>=
library(methimpute)
...
seqlengths(cytosine.positions) <- seqlengths(bsseeker.data) # only necessary
                                                            # for our toy example
...
\subsection{\label{sec:descriptionofcolumns}Description of columns}
\begin{itemize}
...
\begin{small}
<<enrichment_analysis, results='show', message=FALSE, eval=TRUE, fig.width=10, fig.height=4, out.width='0.8\\textwidth', fig.align='center'>>=
...
\begin{small}
<<export_results, results='show', message=FALSE, eval=TRUE>>=
